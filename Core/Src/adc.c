  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = R_FSR_1_ADC_Pin|R_FSR_3_ADC_Pin|L_EMG_1_ADC_Pin|R_FSR_2_ADC_Pin
                          |R_FSR_4_ADC_Pin|L_EMG_3_ADC_Pin|L_EMG_4_ADC_Pin|L_EMG_2_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF12     ------> ADC1_INP6
    */
    HAL_GPIO_DeInit(GPIOC, L_FSR_1_ADC_Pin|L_FSR_2_ADC_Pin);

    HAL_GPIO_DeInit(GPIOF, R_EMG_1_ADC_Pin|R_EMG_2_ADC_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PF14     ------> ADC2_INP6
    */
    HAL_GPIO_DeInit(GPIOF, R_EMG_3_ADC_Pin|R_EMG_4_ADC_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC2_C     ------> ADC3_INP0
    */
    HAL_GPIO_DeInit(GPIOF, R_FSR_1_ADC_Pin|R_FSR_3_ADC_Pin|L_EMG_1_ADC_Pin|R_FSR_2_ADC_Pin
                          |R_FSR_4_ADC_Pin|L_EMG_3_ADC_Pin|L_EMG_4_ADC_Pin|L_EMG_2_ADC_Pin);

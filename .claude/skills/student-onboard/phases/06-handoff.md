# Phase 6 — 핸드오프: 사용자 자율 학습 시작

> 📌 **이 Phase 가 끝나면**: 사용자가 첫 코드 변경 (Ex.00 Quick Start) 을 보드에 반영합니다.
> ⏱️ 예상 시간: 15~30 분 (실험 포함)
> 🧰 사전 조건: Phase 5 통과 (LED 점등 확인)

## 💡 WHY — 왜 Ex.00 부터인가

환경 구축은 끝났습니다. 이제 사용자가 직접 코드를 바꿔보고, **빌드 → 플래시 → 결과 확인** 의 개발 사이클을 직접 돌려봐야 진짜 시작입니다.
...
- 사용자가 student-onboard 를 다시 돌리고 싶다면:
  ```powershell

...
typedef enum _DOP_NodeID_t{
	...
	NODE_ID_EXPPACK	=	(uint8_t)0xA,		// 1010 Angel Suit& RA  ->  Temporary used for Expansion board by 1NE
...
typedef enum _DOP_SDOID_ExtDev_t{
	...
	SDO_ID_EXTDEV_EXTENSION_BOARD_ENABLE,
	SDO_ID_EXTDEV_EXTENSION_BOARD_DISABLE,

	SDO_ID_EXTDEV_ACTUAL_CURRENT_RH,
	SDO_ID_EXTDEV_ACTUAL_CURRENT_LH,

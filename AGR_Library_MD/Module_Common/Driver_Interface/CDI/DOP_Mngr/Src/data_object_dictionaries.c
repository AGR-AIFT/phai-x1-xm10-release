...
void DOP_CreateSDOTable(void)
{
	...
	AssembleSDO( &SDOTable [TASK_ID_EXTDEV] [SDO_ID_EXTDEV_ACTUAL_CURRENT_RH],								DOP_INT16);
	AssembleSDO( &SDOTable [TASK_ID_EXTDEV] [SDO_ID_EXTDEV_ACTUAL_CURRENT_LH],								DOP_INT16);

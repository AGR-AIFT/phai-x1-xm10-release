...
> 보드 외관 사진은 [`assets/img/`](../../assets/img/) 폴더에 추가될 예정입니다.
...
> 자세한 위치/사진은 보드 외관 다이어그램 참조 (사용자가 추가 예정).

---

## 보드 외관

<!-- 사용자가 보드 사진 + 인터페이스 라벨 다이어그램 추가 예정 -->

```
[보드 평면도 / 측면도 placeholder]

LED 1  LED 2  LED 3      BTN 1  BTN 2  BTN 3
  ○      ○     ○            ▼      ▼      ▼

[메인 커넥터 — KIT H10]   [SWD 4-pin]
[CAN-FD 확장 포트]         [USB-C]
[외부 GPIO 헤더]            [외부 UART]
```

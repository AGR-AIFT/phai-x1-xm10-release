...
| 8 | 외부 모듈 연동 + RTOS 유틸리티 + Sensor Hub | Ex.37~42 |
...
알고리즘 작성하면서 옆에 두고 보는 문서. 처음부터 다 읽을 필요는 없습니다.
...
보드에 뭐가 몇 개 있는지, 어디에 꽂는지. 외부 GPIO 핀맵은 자주 보게 되는 페이지라 Rev 1.1 / Rev 2.0 별로 분리되어 있습니다.

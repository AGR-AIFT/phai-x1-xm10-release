...
| LED 가 안 켜집니다 | [Ex.00 Quick Start README](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/00_Quick_Start/) |
...
| 입문자가 첫 30 분 동선 | [examples/README.md - 처음 오신 분](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/README.md#처음-오신-분--첫-30-분-동선) |
| PD 제어 / 임피던스 / CPG 등 알고리즘 예제 | examples/14, 15, 20~30 (자세한 매핑은 [examples/README.md](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/README.md)) |
...
| 상황 | 어디로 |
|------|--------|
| 버전 / 변경 이력 | [CHANGELOG.md](https://github.com/AGR-AIFT/phai-x1-xm10-release/blob/Develop/CHANGELOG.md) |
| 릴리즈 첨부 파일 / 호환성 매트릭스 | [docs/release-notes/](release-notes/) |
| 라이선스 | [LICENSE](https://github.com/AGR-AIFT/phai-x1-xm10-release/blob/Develop/LICENSE) |

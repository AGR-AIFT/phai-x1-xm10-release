...
**See also**: [`XmExtPwrVoltage_t`](#xmextpwrvoltage_t-🟢-rev-20-only), [40_EMG_Proportional_Assist example](https://github.com/AGR-EXO/Extension_Module/tree/Develop/examples/40_EMG_Proportional_Assist/)

...
> ⏱️ 예상 학습 시간: 15분
> 🧰 사전 지식: [Ex.01](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/01_Button_LED_Basic/) (폴링) + [Ex.02](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/02_Button_LED_Event/) (이벤트) + [Ex.03](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/03_Button_LED_FSM/) (롱프레스)
...
| 예제 | 난이도 | LED/버튼 활용 |
|------|--------|-------------|
| [00_Quick_Start](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/00_Quick_Start/) | 입문 | 부팅 시퀀스 + 토글 |
| [01_Button_LED_Basic](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/01_Button_LED_Basic/) | 초급 | 폴링 상태 미러링 |
| [02_Button_LED_Event](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/02_Button_LED_Event/) | 초급 | 이벤트 + ONESHOT |
| [03_Button_LED_FSM](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/03_Button_LED_FSM/) | 중급 | 롱프레스 + Heartbeat/Blink |
| [18_Debug_Monitor](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/18_Debug_Monitor/) | 중급 | 진단 LED 패턴 |

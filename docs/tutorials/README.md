...
| 예제 | 제목 | 난이도 | 학습 내용 |
| :---: | :--- | :---: | :--- |
| [00](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/00_Quick_Start/) | 보드 동작 확인 | ⭐ | 상태 머신 + LED + USB 시리얼 — 외부 하드웨어 없이 |
...
| 예제 | 제목 | 난이도 | 학습 내용 |
| :---: | :--- | :---: | :--- |
| [01](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/01_Button_LED_Basic/) | 버튼 + LED 기초 | ⭐ | 버튼 상태를 매번 확인해서 LED 제어 |
| [02](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/02_Button_LED_Event/) | 이벤트 + 특수 효과 | ⭐⭐ | 클릭 이벤트 감지, 한 번만 깜빡이는 LED |
| [03](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/03_Button_LED_FSM/) | 상태 머신 (FSM) | ⭐⭐ | 길게 누르기로 모드 전환, 상태별 동작 분리 |

### External I/O — GPIO & ADC (Ex.04 ~ 06)

| 예제 | 제목 | 난이도 | 학습 내용 |
| :---: | :--- | :---: | :--- |
| [04](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/04_Ext_IO_Basic/) | 외부 디지털 제어 | ⭐⭐ | 확장 포트 외부 스위치/LED |
| [05](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/05_Ext_IO_analog/) | 아날로그 센서 입문 | ⭐⭐ | 고정 ADC 핀 전압 측정 |
| [05a](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/05a_Ext_IO_DIO_to_ADC/) | DIO→ADC 동적 전환 | ⭐⭐ | DIO 핀을 ADC 모드로 FSR 읽기 |
| [05b](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/05b_Ext_IO_FSR_8ch/) | FSR 8채널 일괄 | ⭐⭐ | 8 채널 + Resolution 설정 |
| [05c](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/05c_Ext_IO_Mixed_ADC/) | 혼합 ADC 12채널 | ⭐⭐⭐ | 고정 4 + DIO→ADC 8 |
| [05d](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/05d_Ext_IO_DIO_ADC_Hybrid/) | DIO/ADC 하이브리드 | ⭐⭐⭐ | 디지털 + 아날로그 동시 |
| [06](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/06_Ext_IO_Safety_Switch/) | 안전 상태 머신 | ⭐⭐ | 리미트 스위치 기반 FSM |
...
| 예제 | 제목 | 난이도 | 학습 내용 |
| :---: | :--- | :---: | :--- |
| [11](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/11_Passive_Mode/) | Passive (수동 모드) | ⭐⭐⭐ | 사전 정의 움직임 명령으로 자동 왕복 |
| [12](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/12_Active_Assist_Mode/) | Active Assist (능동 보조) | ⭐⭐⭐ | 사용자 의도 감지 후 보조 토크 |
| [13](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/13_Resistive_Mode/) | Resistive (저항 모드) | ⭐⭐ | H10 내장 모드 — 물속 걷기 같은 저항감 |
...
| 예제 | 제목 | 난이도 | 학습 내용 |
| :---: | :--- | :---: | :--- |
| [14](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/14_PD_Realtime_Control/) | PD 실시간 토크 제어 | ⭐⭐⭐ | PD 수식, 이산 미분, 토크 포화 |
| [15](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/15_Inverted_Pendulum_Control/) | 역진자 모델 보행 보조 | ⭐⭐⭐ | 중력 보상 MgL·sin(θ) + Lyapunov 안정성 |
| [16](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/16_TinyAI_Sensor_Fusion/) | Tiny AI 센서 퓨전 | ⭐⭐⭐ | 보드 안에서 3-layer 신경망 추론 |
| [17](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/17_FSM_Gait_Intent/) | 보행 의도 인식 (FSM) | ⭐⭐⭐ | 보행 7 단계 상태 머신 + 단계별 토크 |
| [18](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/18_Debug_Monitor/) | 시스템 디버깅 모니터 | ⭐⭐ | 루프 실행 시간 측정, 상태 대시보드 |
| [19](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/19_Memory_Aware_Design/) | 메모리 인식 설계 | ⭐⭐⭐ | 링 버퍼, 풀 할당자, malloc 없이 구현 |
...
| 예제 | 제목 | 난이도 | 학습 내용 |
| :---: | :--- | :---: | :--- |
| [20](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/20_Impedance_Control/) | Hogan 임피던스 제어 | ⭐⭐⭐ | 가상 스프링-댐퍼 상호작용 (Hogan 1985) |
| [21](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/21_Gravity_Compensation/) | 중력 보상 (투명 모드) | ⭐⭐⭐ | Mgl·sin(θ) + 마찰 보상 + 점진 활성화 |
| [22](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/22_CPG_Oscillator/) | CPG 적응 진동자 | ⭐⭐⭐ | 보행 리듬 자동 동기화 (Ronsse 2011) |
| [23](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/23_Gait_Phase_Adaptive_Torque/) | 보행 위상 적응 토크 | ⭐⭐⭐ | 4 구간 정현파 토크 (Quinlivan 2017) |
| [24](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/24_Virtual_Constraint/) | 가상 구속 (HZD) | ⭐⭐⭐ | 5 차 Bézier 궤도 (Westervelt 2003) |
| [25](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/25_Stance_Stiffness_Modulation/) | 입각기 가변 강성 | ⭐⭐⭐ | 입각/유각 부드러운 전환 (Collins 2015) |
...
| 예제 | 제목 | 난이도 | 학습 내용 |
| :---: | :--- | :---: | :--- |
| [26](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/26_Iterative_Learning_Control/) | 반복 학습 제어 (ILC) | ⭐⭐⭐ | 주기마다 토크 프로파일 학습 (Emken 2007) |
| [27](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/27_MRAC/) | 모델 참조 적응 제어 | ⭐⭐⭐ | MIT Rule 로 게인 온라인 적응 (Slotine 1991) |
| [28](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/28_Admittance_Control/) | 어드미턴스 제어 | ⭐⭐⭐ | 힘 입력 → 위치 출력 (임피던스의 짝, Keemink 2018) |
| [29](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/29_Bilateral_Coordination/) | 좌·우 협응 제어 | ⭐⭐⭐ | 역위상 대칭 + 약측 강화 (재활용) |
| [30](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/30_FF_FB_Hybrid_Control/) | FF + FB 혼합 제어 | ⭐⭐⭐ | 모델 기반 사전 보상 + PD 피드백 |
...
| 예제 | 제목 | 난이도 | 학습 내용 |
| :---: | :--- | :---: | :--- |
| [31](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/31_Friction_Comp_DOB/) | 외란 관측기 (DOB) | ⭐⭐⭐ | 남은 외란까지 추정해서 진정한 투명 모드 |
| [32](https://github.com/AGR-AIFT/phai-x1-xm10-release/tree/Develop/examples/32_GRF_Gait_Intent/) | 발 접지로 의도 감지 | ⭐⭐⭐ | Heel Strike 이벤트로 보행 위상 추정 |

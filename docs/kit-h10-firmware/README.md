...
| :---: | :---: | :---: | :--- |
| **v2.0.0** | **CM v2.3.0 / ESP32 v2.3.0 / SAM10 v2.3.0** | **2025.02** | **최신 — 권장** |
| v1.0.x | 기존 출하 버전 | 기존 출하 버전 | Legacy |

> **v1.0.x 사용자:** XM FW를 v2.0.0으로 업그레이드하지 않고 v1.0.x를 그대로 사용하는 경우, KIT H10 FW도 기존 출하 버전을 유지해야 합니다. XM v2.0.0과 구 버전 H10 FW를 혼용하면 프로토콜 불일치로 정상 동작하지 않습니다.
...
**Q: XM v2.0.0을 설치했는데 KIT H10 FW를 업데이트하지 않으면?**

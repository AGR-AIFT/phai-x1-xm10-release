...
XM10 은 KIT H10 본체에서 24V 전원과 통신을 받습니다. 한 가닥이라도 잘못 연결되면 보드가 안 켜지거나, 로봇과 통신이 안 되거나, 펌웨어를 못 쓰는 상황이 생깁니다. 실제로 펌웨어 작성보다 연결 문제로 시간을 더 잃는 경우가 많습니다. 처음에 신중하게.
...
|:---:|:---:|
| v2.3.0 (최신) | CM v2.3.0 / ESP32 v2.3.0 / SAM10 v2.3.0 |
| v2.2.2 (이전) | CM v2.3.0 / ESP32 v2.3.0 / SAM10 v2.3.0 |
...
- **부팅 직후 LED 도 안 보이는데 ST-Link 는 잡힘** — 부트로더가 안 깔려 있을 수 있습니다. [bootloader 가이드](../bootloader/) 확인

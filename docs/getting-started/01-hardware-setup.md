...
## 사전 확인: KIT H10 펌웨어 호환성

XM10은 KIT H10과 CAN-FD로 통신하므로, **XM FW 버전에 맞는 H10 펌웨어**가 설치되어 있어야 합니다.

| XM FW | 필요한 KIT H10 FW |
| :---: | :---: |
| **v2.0.0** | **CM v2.3.0 / ESP32 v2.3.0 / SAM10 v2.3.0** |
| v1.0.x | 기존 출하 버전 유지 |

> H10 FW 업데이트가 필요한 경우 → **[KIT H10 Firmware 가이드](../kit-h10-firmware/)**

...
<p align="center">
  <a href="https://github.com/AGR-EXO/Extension_Module/releases/tag/v2.3.0"><img src="https://img.shields.io/badge/Release-v2.3.0-brightgreen.svg" alt="Release"></a>
...
📦 **다운로드**: [Releases v2.3.0](https://github.com/AGR-EXO/Extension_Module/releases/tag/v2.3.0) → Assets 섹션
...
> **H10 펌웨어 버전 확인**: XM v2.3.0 은 **KIT H10 v2.3.0** 과 짝입니다. 구버전이면 먼저 → [KIT H10 Firmware 가이드](docs/kit-h10-firmware/)

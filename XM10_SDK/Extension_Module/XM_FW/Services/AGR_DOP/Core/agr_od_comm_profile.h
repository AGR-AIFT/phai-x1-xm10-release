...
#define AGR_OD_COMM_DEVICE_TYPE(ptr) \
    { AGR_OD_IDX_DEVICE_TYPE, 0x00, AGR_TYPE_UINT32, 4, AGR_ACCESS_RO, (void*)(ptr), NULL }

/** @brief 0x1001 Error Register (UINT8, RO) */
#define AGR_OD_COMM_ERROR_REGISTER(ptr) \
    { AGR_OD_IDX_ERROR_REGISTER, 0x00, AGR_TYPE_UINT8, 1, AGR_ACCESS_RO, (void*)(ptr), NULL }

/** @brief 0x1017 Producer Heartbeat Time (UINT16, RW) */
#define AGR_OD_COMM_HEARTBEAT_TIME(ptr) \
    { AGR_OD_IDX_HEARTBEAT_TIME, 0x00, AGR_TYPE_UINT16, 2, AGR_ACCESS_RW, (void*)(ptr), NULL }

/** @brief 0x1018 sub 0 - Number of entries (UINT8, RO) */
#define AGR_OD_COMM_IDENTITY_COUNT(ptr) \
    { AGR_OD_IDX_IDENTITY, AGR_OD_SUB_IDENTITY_COUNT, AGR_TYPE_UINT8, 1, AGR_ACCESS_RO, (void*)(ptr), NULL }

/** @brief 0x1018 sub 1 - Vendor ID (UINT32, RO) */
#define AGR_OD_COMM_VENDOR_ID(ptr) \
    { AGR_OD_IDX_IDENTITY, AGR_OD_SUB_VENDOR_ID, AGR_TYPE_UINT32, 4, AGR_ACCESS_RO, (void*)(ptr), NULL }

/** @brief 0x1018 sub 2 - Product Code (UINT32, RO) */
#define AGR_OD_COMM_PRODUCT_CODE(ptr) \
    { AGR_OD_IDX_IDENTITY, AGR_OD_SUB_PRODUCT_CODE, AGR_TYPE_UINT32, 4, AGR_ACCESS_RO, (void*)(ptr), NULL }

/** @brief 0x1018 sub 3 - Revision Number (UINT32, RO) */
#define AGR_OD_COMM_REVISION(ptr) \
    { AGR_OD_IDX_IDENTITY, AGR_OD_SUB_REVISION_NUMBER, AGR_TYPE_UINT32, 4, AGR_ACCESS_RO, (void*)(ptr), NULL }

/** @brief 0x1018 sub 4 - Serial Number (UINT32, RO) */
#define AGR_OD_COMM_SERIAL(ptr) \
    { AGR_OD_IDX_IDENTITY, AGR_OD_SUB_SERIAL_NUMBER, AGR_TYPE_UINT32, 4, AGR_ACCESS_RO, (void*)(ptr), NULL }

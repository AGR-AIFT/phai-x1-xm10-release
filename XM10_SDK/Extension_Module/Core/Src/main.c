...
int main(void)
{
  ...
  /* [CRITICAL] UserTask Priority Override ⭐ KING
   * - IOC 설정값(Realtime4)을 Realtime6으로 상향
   * - 제어 공학적 원칙: Main Control Loop가 최우선
   * - FDCAN Rx Task(Realtime4)보다 높아야 함
   */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : USB_OTG_UFP_ID_Pin */
  GPIO_InitStruct.Pin = USB_OTG_UFP_ID_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.Alternate = GPIO_AF10_OTG1_FS;
  HAL_GPIO_Init(USB_OTG_UFP_ID_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : USB_OTG_FS_DP_Pin USB_OTG_FS_DM_Pin */

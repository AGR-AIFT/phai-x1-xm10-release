 ...
 *   OD 엔트리 모음. Extension_Module_GUI_ForProduction GUI가 SDO Read/Write로 보드 식별, Test Mode
 ...
 *     0x7F00        : Peripheral Test Runner (Phase 2, Extension_Module_GUI_ForProduction 표준 호환)
 *
...
void     XM_ProductionOD_ForceSafeExit(void);

 ...
 *   - FES Hub = 0x0C, IMU Hub = 0x0D (단일 노드), EMG Hub = 0x0F
 */
typedef enum {
    SYS_NODE_ID_ALL   = 0x0,
    ...
    SYS_NODE_ID_LH    = 0x7, // Left Hip(Sagittal)
    SYS_NODE_ID_RK    = 0x8, // Right Knee(Sagittal)
    SYS_NODE_ID_LK    = 0x9, // Left Knee(Sagittal)
...
typedef enum _DOP_NodeID_t{
	...
	NODE_ID_EXTPACK =	(uint8_t)0x2,		// 0010
...
typedef enum _DOP_StateStatus_t{
	STATE_IDLE,
	STATE_STANDBY,
	STATE_ENABLE,
	STATE_ERROR,
...
typedef enum _DOP_TaskID_t{
	/* DO NOT CHANGE */
	TASK_ID_LOWLEVEL = 0,	// extension algorithm (EXT_TASK_ID_EXT_ALGORITHM)
	TASK_ID_MIDLEVEL,		// extension sensor daq (EXT_TASK_ID_EXT_SENSOR_DAQ)
	TASK_ID_MSG,			// extension msg hdlr (EXT_TASK_ID_EXT_MSG)
	TASK_ID_IMU,			// extension nmt (EXT_TASK_ID_EXT_NMT)
	TASK_ID_GAIT,
	TASK_ID_SYSMNGT_MD,
	TASK_ID_EXTDEV,
	TASK_ID_SYSMNGT_CM,
...
typedef enum _DOP_Ext_TaskID_t{
	/* DO NOT CHANGE */
	EXT_TASK_ID_EXT_ALGORITHM,
	EXT_TASK_ID_EXT_SENSOR_DAQ,
	EXT_TASK_ID_EXT_MSG,
	EXT_TASK_ID_EXT_NMT,
	EXT_TASK_NUM
	/* DO NOT CHANGE */
...
typedef enum _DOP_SDOID_ExtDev_t{
	...
	/* For Extension Board */
	SDO_ID_EXTDEV_GET_THIGH_THETA_RH,
	SDO_ID_EXTDEV_GET_THIGH_THETA_LH,
	SDO_ID_EXTDEV_GET_THETA_RH,
	SDO_ID_EXTDEV_GET_THETA_LH,
	SDO_ID_EXTDEV_GET_ACCX_RH,
	SDO_ID_EXTDEV_GET_ACCX_LH,
	SDO_ID_EXTDEV_GET_ACCY_RH,
	SDO_ID_EXTDEV_GET_ACCY_LH,
	SDO_ID_EXTDEV_GET_GYRZ_RH,
	SDO_ID_EXTDEV_GET_GYRZ_LH,
	SDO_ID_EXTDEV_GET_ASSIST_LEVEL,

	SDO_ID_EXTDEV_MOTIONMAP_ID,
	SDO_ID_EXTDEV_P_VECTOR_YD_RH,
	SDO_ID_EXTDEV_P_VECTOR_L_RH,
	SDO_ID_EXTDEV_P_VECTOR_S0_RH,
	SDO_ID_EXTDEV_P_VECTOR_SD_RH,
	SDO_ID_EXTDEV_P_VECTOR_YD_LH,
	SDO_ID_EXTDEV_P_VECTOR_L_LH,
	SDO_ID_EXTDEV_P_VECTOR_S0_LH,
	SDO_ID_EXTDEV_P_VECTOR_SD_LH,

	SDO_ID_EXTDEV_RH_P_VECTOR_DURATION_COMPLETED,
	SDO_ID_EXTDEV_LH_P_VECTOR_DURATION_COMPLETED,
	SDO_ID_EXTDEV_FSM_CURR,

	SDO_ID_EXTDEV_F_VECTOR_MODEID_RH,
	SDO_ID_EXTDEV_F_VECTOR_COEFFICIENT_RH,
	SDO_ID_EXTDEV_F_VECTOR_GLOBALID_RH,
	SDO_ID_EXTDEV_F_VECTOR_DELAY_RH,
	SDO_ID_EXTDEV_F_VECTOR_MODEID_LH,
	SDO_ID_EXTDEV_F_VECTOR_COEFFICIENT_LH,
	SDO_ID_EXTDEV_F_VECTOR_GLOBALID_LH,
	SDO_ID_EXTDEV_F_VECTOR_DELAY_LH,
...
typedef enum _DOP_SDOID_WholeBody_t{
	...
	// Extenstion Board
	SDO_ID_WHOLEBODY_EXTENSION_BOARD_ENABLE,
	SDO_ID_WHOLEBODY_EXTENSION_BOARD_DISABLE,
	
	SDO_ID_WHOLEBODY_PDO_LIST,
	SDO_ID_WHOLEBODY_SDO_LIST,

	SDO_ID_WHOLEBODY_EXT_NMT_BOOTUP,	// 확장팩의 bootup SDO
	SDO_ID_WHOLEBODY_EXT_NMT_STATE,		// 확장팩의 NMT State SDO
	SDO_ID_WHOLEBODY_EXT_NMT_HEARTBEAT,	// 확장팩의 Heartbeat SDO

	SDO_ID_WHOLEBODY_P_VECTOR_YD_RH,
	SDO_ID_WHOLEBODY_P_VECTOR_L_RH,
	SDO_ID_WHOLEBODY_P_VECTOR_S0_RH,
	SDO_ID_WHOLEBODY_P_VECTOR_SD_RH,
	SDO_ID_WHOLEBODY_P_VECTOR_YD_LH,
	SDO_ID_WHOLEBODY_P_VECTOR_L_LH,
	SDO_ID_WHOLEBODY_P_VECTOR_S0_LH,
	SDO_ID_WHOLEBODY_P_VECTOR_SD_LH,
	SDO_ID_WHOLEBODY_I_VECTOR_EPSILON_RH,
	SDO_ID_WHOLEBODY_I_VECTOR_KP_RH,
	SDO_ID_WHOLEBODY_I_VECTOR_KD_RH,
	SDO_ID_WHOLEBODY_I_VECTOR_LAMBDA_RH,
	SDO_ID_WHOLEBODY_I_VECTOR_DURATION_RH,
	SDO_ID_WHOLEBODY_I_VECTOR_KP_MAX_RH,
	SDO_ID_WHOLEBODY_I_VECTOR_KD_MAX_RH,
	SDO_ID_WHOLEBODY_I_VECTOR_EPSILON_LH,
	SDO_ID_WHOLEBODY_I_VECTOR_KP_LH,
	SDO_ID_WHOLEBODY_I_VECTOR_KD_LH,
	SDO_ID_WHOLEBODY_I_VECTOR_LAMBDA_LH,
	SDO_ID_WHOLEBODY_I_VECTOR_DURATION_LH,
	SDO_ID_WHOLEBODY_I_VECTOR_KP_MAX_LH,
	SDO_ID_WHOLEBODY_I_VECTOR_KD_MAX_LH,
	SDO_ID_WHOLEBODY_F_VECTOR_MODE_IDX_RH,
	SDO_ID_WHOLEBODY_F_VECTOR_TMAX_RH,
	SDO_ID_WHOLEBODY_F_VECTOR_DELAY_RH,
	SDO_ID_WHOLEBODY_F_VECTOR_MODE_IDX_LH,
	SDO_ID_WHOLEBODY_F_VECTOR_TMAX_LH,
	SDO_ID_WHOLEBODY_F_VECTOR_DELAY_LH,

	SDO_ID_WHOLEBODY_NUM
} DOP_SDOID_WholeBody_t;

typedef enum _DOP_ExtSDOID_Algorithm_t{
	SDO_ID_EXT_ALGORITHM_GET_STATE = 0,
	SDO_ID_EXT_ALGORITHM_SET_STATE,
	SDO_ID_EXT_ALGORITHM_GET_ROUTINE,
	SDO_ID_EXT_ALGORITHM_SET_ROUTINE,
	SDO_ID_EXT_ALGORITHM_CLEARALL_ROUTINE,

	SDO_ID_EXT_ALGORITHM_NUM
} DOP_ExtSDOID_Algorithm_t;

typedef enum _DOP_ExtSDOID_SensorDAQ_t{
	SDO_ID_EXT_SENSOR_DAQ_GET_STATE = 0,
	SDO_ID_EXT_SENSOR_DAQ_SET_STATE,
	SDO_ID_EXT_SENSOR_DAQ_GET_ROUTINE,
	SDO_ID_EXT_SENSOR_DAQ_SET_ROUTINE,
	SDO_ID_EXT_SENSOR_DAQ_CLEARALL_ROUTINE,

	SDO_ID_EXT_SENSOR_DAQ_NUM
} DOP_ExtSDOID_SensorDAQ_t;

typedef enum _DOP_ExtSDOID_Msg_t{
	SDO_ID_EXT_MSG_GET_STATE = 0,
	SDO_ID_EXT_MSG_SET_STATE,
	SDO_ID_EXT_MSG_GET_ROUTINE,
	SDO_ID_EXT_MSG_SET_ROUTINE,
	SDO_ID_EXT_MSG_CLEARALL_ROUTINE,

	SDO_ID_EXT_MSG_NUM
} DOP_ExtSDOID_Msg_t;

typedef enum _DOP_ExtSDOID_NMT_t{
	SDO_ID_EXT_NETWORK_MNGT_GET_STATE = 0,
	SDO_ID_EXT_NETWORK_MNGT_SET_STATE,
	SDO_ID_EXT_NETWORK_MNGT_GET_ROUTINE,
	SDO_ID_EXT_NETWORK_MNGT_SET_ROUTINE,
	SDO_ID_EXT_NETWORK_MNGT_CLEARALL_ROUTINE,

    SDO_ID_EXT_NETWORK_MNGT_CM_NMT_BOOTUP,		// CM의 Boot-up SDO
	SDO_ID_EXT_NETWORK_MNGT_CM_NMT_STATE,		// CM의 NMT State SDO
	SDO_ID_EXT_NETWORK_MNGT_CM_NMT_HEARTBEAT,	// CM의 Heartbeat SDO

    SDO_ID_EXT_NETWORK_MNGT_NMT_NUM
} DOP_ExtSDOID_NMT_t;
...
typedef enum _DOP_PDOID_ExtDev_t{
	...
	/* Used PDO for Extension Board */
	PDO_ID_EXTDEV_PMMG_1A,
	PDO_ID_EXTDEV_PMMG_1B,
	PDO_ID_EXTDEV_PMMG_2A,
	PDO_ID_EXTDEV_PMMG_2B,
	PDO_ID_EXTDEV_PMMG_3A,
	PDO_ID_EXTDEV_PMMG_3B,
	PDO_ID_EXTDEV_PMMG_4A,
	PDO_ID_EXTDEV_PMMG_4B,

	PDO_ID_EXTDEV_EMG_L1,
	PDO_ID_EXTDEV_EMG_L2,
	PDO_ID_EXTDEV_EMG_L3,
	PDO_ID_EXTDEV_EMG_L4,
	PDO_ID_EXTDEV_EMG_R1,
	PDO_ID_EXTDEV_EMG_R2,
	PDO_ID_EXTDEV_EMG_R3,
	PDO_ID_EXTDEV_EMG_R4,

	PDO_ID_EXTDEV_FSR_L1,
	PDO_ID_EXTDEV_FSR_L2,
	PDO_ID_EXTDEV_FSR_L3,
	PDO_ID_EXTDEV_FSR_L4,
	PDO_ID_EXTDEV_FSR_R1,
	PDO_ID_EXTDEV_FSR_R2,
	PDO_ID_EXTDEV_FSR_R3,
	PDO_ID_EXTDEV_FSR_R4,

	PDO_ID_EXTDEV_EMG_HARDEMO_1,
	PDO_ID_EXTDEV_EMG_HARDEMO_2,
	PDO_ID_EXTDEV_EMG_HARDEMO_3,

	PDO_ID_EXTDEV_CONTROL_INPUT_RH,
	PDO_ID_EXTDEV_CONTROL_INPUT_LH,
	PDO_ID_EXTDEV_EMG_RAW,
	PDO_ID_EXTDEV_EMG_PROCESSED,

	PDO_ID_EXTDEV_PVECTOR_REF_RH,
	PDO_ID_EXTDEV_PVECTOR_REF_LH,

	PDO_ID_EXTDEV_CONTROL_MODE,
	PDO_ID_EXTDEV_ACK_SIGNAL,

	PDO_ID_EXTDEV_FREE_VAR1,
	PDO_ID_EXTDEV_FREE_VAR2,

	PDO_ID_EXTDEV_QUATERNION_W,
	PDO_ID_EXTDEV_QUATERNION_X,
	PDO_ID_EXTDEV_QUATERNION_Y,
	PDO_ID_EXTDEV_QUATERNION_Z,

	PDO_ID_EXTDEV_NUM
} DOP_PDOID_ExtDev_t;

typedef enum _DOP_PDOID_WholeBody_t{
	PDO_ID_WHOLEBODY_LEFT_HIP_JOINT_ANGLE,
	PDO_ID_WHOLEBODY_RIGHT_HIP_JOINT_ANGLE,
	PDO_ID_WHOLEBODY_LEFT_THIGH_ANGLE,
	PDO_ID_WHOLEBODY_RIGHT_THIGH_ANGLE,
	PDO_ID_WHOLEBODY_LEFT_PELVIC_ANGLE,
	PDO_ID_WHOLEBODY_RIGHT_PELVIC_ANGLE,
	PDO_ID_WHOLEBODY_LEFT_KNEE_JOINT_ANGLE,
	PDO_ID_WHOLEBODY_RIGHT_KNEE_JOINT_ANGLE,
	PDO_ID_WHOLEBODY_LEFT_FOOT_CONTACT,
	PDO_ID_WHOLEBODY_RIGHT_FOOT_CONTACT,
	PDO_ID_WHOLEBODY_GAIT_STATE,
	PDO_ID_WHOLEBODY_GAIT_CYCLE,
	PDO_ID_WHOLEBODY_FORWARD_VELOCITY,
	PDO_ID_WHOLEBODY_NUM
} DOP_PDOID_WholeBody_t;

typedef enum _DOP_PDOID_Ext_Algorithm_t{
	PDO_ID_EXT_ALGORITHM_LEFT_AUX_INPUT,
	PDO_ID_EXT_ALGORITHM_RIGHT_AUX_INPUT,
	PDO_ID_EXT_ALGORITHM_NUM
} DOP_PDOID_Ext_Algorithm_t;
...
typedef enum _DOP_RoutID_ExtDev_t{
	...
	ROUTINE_ID_EXTDEV_P_VECTOR_DECODER_RH,
	ROUTINE_ID_EXTDEV_P_VECTOR_DECODER_LH,

	ROUTINE_ID_EXTDEV_F_VECTOR_DECODER_RH,
	ROUTINE_ID_EXTDEV_F_VECTOR_DECODER_LH,

...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
// static AGRBStatusDef _debug_adc_assign;
// static AGRBStatusDef _debug_uart7_status;
// static AGRBStatusDef _debug_uart8_status;
// TaskUSBControlTask_Init_t usbControlInitStruct;
...
int main(void)
{
  ...
  /* [Phase2 D2] 부팅 진단 초기화 — .noinit 매직 검증/재초기화.
   * Error_Handler 의 bounded-retry 가 consec_fail 을 신뢰하려면 반드시 선행한다
   * (POR 직후 .noinit 은 garbage — 매직 불일치 시 여기서 0 으로 확정). */
  XM_BootDiagClear();
  XM_BOOT_DIAG_MARK(0x1001u);

  /* [진단] 리셋 원인 이력 누적 — RSR 은 매 리셋 HW 가 세팅하므로 .noinit 생존
   * 여부와 무관하게 신뢰 가능하다. D-Cache enable 이전·단일 컨텍스트에서 1회.
   * 판독: bor_count 우세=전원(BOR) / sftrst_count 우세=SW fault (rule 37 §1-1). */
  {
      uint32_t rsr = RCC->RSR;
      g_xm_boot_diag.reset_flags = rsr;
      ResetCause_Record(rsr);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOG, HMMG_PWR_EN_Pin|L_GRF_PWR_EN_Pin|R_GRF_PWR_EN_Pin|IMU_PWR_EN_Pin
                          |FES_PWR_EN_Pin|EMG_PWR_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, USB_PWR_ON_Pin|TP12_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(EXT_PWR_EN_GPIO_Port, EXT_PWR_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, FUNC_LED_2_Pin|FUNC_LED_1_Pin|FUNC_LED_3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, CM_LED_G_Pin|CM_LED_B_Pin|CM_LED_R_Pin|POWER_ON_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, TP11_Pin|TP5_Pin|TP9_Pin|TP10_Pin
                          |TP7_Pin|TP8_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : HMMG_PWR_EN_Pin L_GRF_PWR_EN_Pin R_GRF_PWR_EN_Pin IMU_PWR_EN_Pin
                           FES_PWR_EN_Pin EMG_PWR_EN_Pin */
  GPIO_InitStruct.Pin = HMMG_PWR_EN_Pin|L_GRF_PWR_EN_Pin|R_GRF_PWR_EN_Pin|IMU_PWR_EN_Pin
                          |FES_PWR_EN_Pin|EMG_PWR_EN_Pin;
  ...
  /*Configure GPIO pins : IMU__FAULT_Pin HMMG__FAULT_Pin R_GRF__FAULT_Pin L_GRF__FAULT_Pin
                           FES__FAULT_Pin EMG__FAULT_Pin HWREV_2_Pin HWREV_1_Pin */
  GPIO_InitStruct.Pin = IMU__FAULT_Pin|HMMG__FAULT_Pin|R_GRF__FAULT_Pin|L_GRF__FAULT_Pin
                          |FES__FAULT_Pin|EMG__FAULT_Pin|HWREV_2_Pin|HWREV_1_Pin;
  ...
  /*Configure GPIO pin : USB_PWR_ON_Pin */
  GPIO_InitStruct.Pin = USB_PWR_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(USB_PWR_ON_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : EXT_PWR_EN_Pin */
  GPIO_InitStruct.Pin = EXT_PWR_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(EXT_PWR_EN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : FUNC_LED_2_Pin FUNC_LED_1_Pin FUNC_LED_3_Pin */
  GPIO_InitStruct.Pin = FUNC_LED_2_Pin|FUNC_LED_1_Pin|FUNC_LED_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : TP11_Pin TP5_Pin TP9_Pin TP10_Pin
                           TP7_Pin */
  GPIO_InitStruct.Pin = TP11_Pin|TP5_Pin|TP9_Pin|TP10_Pin
                          |TP7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : USB_OC__DET_Pin */
  GPIO_InitStruct.Pin = USB_OC__DET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(USB_OC__DET_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : TP8_Pin */
  GPIO_InitStruct.Pin = TP8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TP8_GPIO_Port, &GPIO_InitStruct);

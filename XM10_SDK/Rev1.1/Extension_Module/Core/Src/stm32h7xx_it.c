...
#include "external_io.h"  /* For System_ISR_ADC3*() */
...
/* USER CODE BEGIN 1 */
/**
 * @brief This function handles DMA2 stream0 global interrupt (UART4 RX DMA).
 * @details ✅ Core → System → IOIF 위임 구조 (ADC3 패턴과 동일)
 */
...
/**
 * @brief This function handles DMA2 stream1 global interrupt (UART4 TX DMA).
 * @details ✅ Core → System → IOIF 위임 구조 (ADC3 패턴과 동일)
 */
...
/**
 * @brief This function handles DMA2 stream2 global interrupt (ADC3 DMA).
 * @details ✅ Core → System → IOIF 위임 구조
 */
...
void UART4_IRQHandler(void)
{
  ...
  System_ISR_UART4();  /* ✅ System Layer 호출 */
...
void ADC3_IRQHandler(void)
{
  ...
  System_ISR_ADC3();  /* ✅ System Layer 호출 */

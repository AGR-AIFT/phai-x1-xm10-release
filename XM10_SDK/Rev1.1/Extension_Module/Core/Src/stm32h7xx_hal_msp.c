...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PF11     ------> ADC1_INP2
    */
    GPIO_InitStruct.Pin = EXT_ADC_3_Pin|EXT_ADC_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = USB_ADC_IN2_Pin|USB_ADC_IN1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(GPIOA, EXT_ADC_3_Pin|EXT_ADC_1_Pin);

    HAL_GPIO_DeInit(GPIOF, USB_ADC_IN2_Pin|USB_ADC_IN1_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    */
    GPIO_InitStruct.Pin = L_GRF_UART_TX_Pin|L_GRF_UART_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART7)
  {
    ...
    PB3 (JTDO/TRACESWO)     ------> UART7_RX
    */
    HAL_GPIO_DeInit(GPIOB, L_GRF_UART_TX_Pin|L_GRF_UART_RX_Pin);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* hpcd)
{
  if(hpcd->Instance==USB_OTG_FS)
  {
    ...
    PA11     ------> USB_OTG_FS_DM
    */
    HAL_GPIO_DeInit(GPIOA, USB_OTG_UFP_ID_Pin|USB_OTG_FS_DP_Pin|USB_OTG_FS_DM_Pin);

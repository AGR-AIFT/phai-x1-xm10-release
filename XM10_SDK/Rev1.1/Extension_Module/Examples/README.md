...
이 Rev 1.1 SDK 는 전체 50 개 예제 중 47 개를 포함합니다 (Ex.40~42 는 Rev 2.0 전용이라 제외). 각 폴더에 소스 코드 `.c` 와 그 예제만의 설명서 `README.md` 가 함께 들어있습니다.
...
**보드 리비전 호환성** — 이 SDK 에 포함된 47 개 예제는 Rev 1.1 / Rev 2.0 양쪽 모두 빌드·실행됩니다 (Ex.40~42 는 Rev 2.0 SDK 에만 포함). 다만 두 가지 주의 사항이 있습니다.
...
기본기를 다진 다음, 47 개 예제는 다섯 단계의 흐름을 따라갑니다. "로봇이 인간을 어떻게 이해하고, 함께 성장하는가" 라는 한 줄로 묶을 수 있습니다.

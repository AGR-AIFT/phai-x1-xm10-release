...
기존 raw format (V1, FW 구버전 로그)도 하위 호환으로 자동 인식합니다.

사용법:
    python data_decoder_xm10.py <session_folder>
    python data_decoder_xm10.py /LOGS/B005_003
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("XM10 USB MSC Binary Data Decoder")
        print("=" * 40)
        print("Usage: python data_decoder_xm10.py <session_folder>")
        print()
        print("Examples:")
        print("  python data_decoder_xm10.py /LOGS/B005_003")
        print("  python data_decoder_xm10.py .  (current folder)")
        print()
        print("Supports:")

...
- **`XM_SetControlMode()`** — `XM_CTRL_MONITOR` (제어 X, 모니터링만) vs `XM_CTRL_CONTROL` (사용자 토크 제어). ([api-ref](../../docs/api-reference/02-h10-control-n-data.md))
...
static void Active_Entry(void)
{
    ...
    XM_SetControlMode(XM_CTRL_CONTROL);                              // ⑤ 토크 제어 시작
}
